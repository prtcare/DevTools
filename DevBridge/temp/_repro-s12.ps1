...
$outDir = Join-Path $Root "logs\selftest\_repro_s12"
...
$cur = [ordered]@{
  nodeId = "WI-07-0.2.4"; taskId = "WI-07-0.2.4"; name = "DB-M12.4 fixture s12"
...
$comp = [ordered]@{ milestone = "DB-M10"; nodeId = "WI-07-0.2.3"; changeId = "CHG-20260830-016"; status = "COMPLETION_WRITTEN"; completedAtUtc = "2026-08-31T00:00:00Z" }
Write-DevBridgeJson (Join-Path $stateDir "completion.json") $comp | Out-Null
